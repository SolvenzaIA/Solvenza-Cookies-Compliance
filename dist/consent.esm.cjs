...
__export(src_exports, {
  ...
  IframeResourceBlocker: () => IframeResourceBlocker,
  ImageResourceBlocker: () => ImageResourceBlocker,
...
function verifyReceiptIntegrity(payload, expectedSignature, secretKey) {
...
var ScriptResourceBlocker = class {
  constructor() {
    this.type = "script";
  }
  process(isCategoryAllowed, isServiceAllowed) {
...
var IframeResourceBlocker = class {
  constructor() {
    this.type = "iframe";
  }
  process(isCategoryAllowed, isServiceAllowed) {
...
var ImageResourceBlocker = class {
  constructor() {
    this.type = "image";
  }
  process(isCategoryAllowed, isServiceAllowed) {
...
//# sourceMappingURL=consent.esm.cjs.map